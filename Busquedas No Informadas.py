...
print(f'Dijkstra: ruta {inicial}-{final}:{path} peso:{weight}')
...
print("DFS('1'):", g.DFS('1'))          # Recorrido DFS

fin1 = time.time()
print('Tiempo de ejecucion busqueda por profundidad: ', fin1-inicio1)
#---------------------------------------------------------------------------------------------------------------------------
inicio2 = time.time()
...
print("BFS('1'):", g.BFS('1'))          # Recorrido BFS

fin2 = time.time()
print('Tiempo de ejecucion busqueda por amplitud: ', fin2-inicio2)
#---------------------------------------------------------------------------------------------------------------------------
